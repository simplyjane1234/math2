...
export const WorksheetGenerator: React.FC<WorksheetGeneratorProps> = ({ user, onUpdateUser }) => {
  ...
  const canGenerateWorksheet = () => {
    ...
    // Always return true for testing - unlimited access
    return true;
  };
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // No usage tracking for testing - unlimited access
      // if (!user.isPaid) {
    ...
    <div className="space-y-8">
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-green-800 font-medium">Testing Mode: Unlimited Access Enabled</span>
        </div>
        <p className="text-green-700 text-sm mt-1">
          You have unlimited worksheet generation for testing purposes
        </p>
      </div>
